    ...
    <div className="w-80 bg-white border-r flex flex-col">
      ...
      <ScrollArea className="flex-1">
        {chats.map((chat) => (
          <div
            key={chat.id}
            className={`p-3 cursor-pointer flex justify-between items-center rounded hover:bg-gray-100 transition ${
    ...
    <div className="flex-1 flex flex-col relative">
      ...
      <ScrollArea className="flex-1 p-4 space-y-4 overflow-y-auto">
        {activeChat?.messages?.map((msg, i) => (
          ...
          >
            <div
              className={`px-4 py-2 max-w-xs break-words transition-all ${
                msg.role === "user"
      ...
      <div className="w-full flex justify-center p-4 border-t bg-white">
        <div className="flex items-end gap-2 w-full max-w-3xl">
          <TextareaAutosize
            minRows={1}
            maxRows={6}
            className="flex-1 resize-none px-4 py-3 rounded-md border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none placeholder-gray-400 text-gray-900 shadow-sm overflow-auto"            placeholder={activeChat ? "Write your story..." : "Start by typing a prompt..."}
